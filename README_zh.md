...
> 有来源依据的 GPT Image 2 提示词案例，覆盖生成、编辑与多轮创意工作流。
# GPT Image 2 提示词与技能大全
...
> 面向 OpenAI 图像工作流的 GPT Image 2 提示词、可复用提示词技能与视觉案例合集
...
本仓库只使用本仓库链接作为项目入口；模型能力来源链接指向 OpenAI 官方文档。
...
**GPT Image 2** 是 OpenAI 在图像生成与图像编辑文档中提到的 GPT Image 模型。本仓库是一个有来源依据的提示词 collection template：收录案例应保留署名、媒体证据，以及足够复现或改写工作流的上下文。

- **GPT Image 模型** - OpenAI 图像生成指南列出了包括 `gpt-image-2` 在内的 GPT Image 模型
- **Image API** - generations 用于文本生成图片，edits 用于用新提示词修改现有图片
- **Responses API** - 当图像需要留在对话上下文或多步骤流程中时，可使用图像生成工具
- **多轮编辑** - 通过连续提示词细化、追加指令，或编辑对话中的已有图片来迭代结果
- **输出控制** - 在模型支持的范围内，可调整尺寸、质量、输出格式和压缩
- **仓库边界** - 本仓库整理可复用提示词和公开案例，不是 OpenAI 官方文档，也不是模型基准测试

**项目资源:** [OpenAI image generation guide](https://developers.openai.com/api/docs/guides/image-generation) · [OpenAI Image API reference](https://developers.openai.com/api/reference/resources/images) · [GPT Image 2 prompt collection](https://github.com/imaginevid-ai/Awesome-gpt-image-2-prompts-and-skills)
...
| 提示词总数 | **95** |
| 精选 | **12** |
| 最后更新 | **2026年8月23日星期日 UTC 08:24:17** |
...
**[使用这个提示词 · GPT Image 2 Library](https://github.com/imaginevid-ai/Awesome-gpt-image-2-prompts-and-skills)**
...
1. Click [**提交新提示词**](https://github.com/imaginevid-ai/Awesome-gpt-image-2-prompts-and-skills/issues/new?template=submit-prompt.yml)
2. 填写提示词详情和图片信息
3. 提交后等待维护者审核
4. 审核通过后可同步到本地仓库数据
...
**[查看精选合集](https://github.com/imaginevid-ai/Awesome-gpt-image-2-prompts-and-skills)** •
...
<sub>本 README 自动生成。最后更新： 2026-08-23T08:24:17.930Z</sub>
